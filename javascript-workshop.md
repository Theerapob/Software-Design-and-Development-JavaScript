...
<head>
    <meta charset="UTF-8">
    <meta name="viemport" content="width, initial-scale=1.0">
...
const studentId = "67030099";
const studentName = "ธีรภพ พรหมวิหาร";
let midtermscore = 65;
let finalscore = 70;
...
![Capture5](https://github.com/user-attachments/assets/bfc08c55-febf-40ac-a35c-cfa57f7132a5)
